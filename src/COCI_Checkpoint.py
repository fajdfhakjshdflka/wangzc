    ...
    def __init__(self, dataloader, **kwargs):
        ...
        for name, ref in kwargs.items():
            if hasattr(ref, 'state_dict'):
                ...
                print('please input checkpointing content.')
    ...
    def _snapshot_GPU(self,
        ...
        try:
            if self.ck_state == 'idle':
                ...
                # deepcopy dataloader from gpu to cpu
                self.latest_snapshot['dataloader'] = copy.deepcopy(self.dataloader)
        ...
        try:
            ...
            if self.ck_state == 'idle':
                ...
                if not isinstance(meta_state, Mapping):
                    print('meta_state is not Mapping.')
                    return False
